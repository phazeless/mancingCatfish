...
public class IGNLobsterDialog : InGameNotificationDialog<IGNLobster>
{
	protected override void OnAboutToOpen()
	{
		...
		IGNLobster.LobsterCageContent content = this.inGameNotification.Content;
		this.catchType[(int)content].SetActive(true);
		switch (content)
		{
		case IGNLobster.LobsterCageContent.None:
			this.title.SetText("Empty...");
			break;
		case IGNLobster.LobsterCageContent.Small:
			this.title.SetText("Small Catch!");
			break;
		case IGNLobster.LobsterCageContent.Great:
			this.title.SetText("Great Catch!!");
			break;
		case IGNLobster.LobsterCageContent.Huge:
			this.title.SetText("Huge Success!!!");
			break;
		}
		this.customSize = new Vector2?(new Vector2(889f, 885f));
	}
	...
	protected override void OnRemovedFromList()
	{
		...
		if (this.inGameNotification.Content != IGNLobster.LobsterCageContent.None)
		{
