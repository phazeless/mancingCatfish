...
namespace TMPro
{
	...
	public class TextMeshProUGUI : ACETextMeshPro, ILayoutElement
	{
							...
							if (tmp_Glyph == null)
							{
								...
								else
								{
									...
									else if (this.m_currentFontAsset.characterDictionary.TryGetValue(32, out tmp_Glyph))
									{
										if (!TMP_Settings.warningsDisabled)
										{
											UnityEngine.Debug.LogWarning("Character with ASCII value of " + num4 + " was not found in the Font Asset Glyph Table. It was replaced by a space.", this);
										}
										num4 = (chars[num3] = 32);
									}
								}
